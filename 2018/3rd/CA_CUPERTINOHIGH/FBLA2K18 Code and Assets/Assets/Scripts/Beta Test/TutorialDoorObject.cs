...
public class TutorialDoorObject : MonoBehaviour {
    ...
    private void OnGUI()
    {
        ...
        if (isInteractable) GUI.Box(new Rect(Screen.width / 2 - Screen.width / 6 / 2, Screen.height - Screen.height / 8, Screen.width / 6, Screen.height / 8), ("Open [E]"));
